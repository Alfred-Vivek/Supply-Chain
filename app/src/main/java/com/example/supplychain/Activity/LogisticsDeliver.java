...
public class LogisticsDeliver extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public void loadPackageApi() {
        ...
        call.enqueue(new Callback<LogisticPackageResponse>() {
            ...
            public void onFailure(Call<LogisticPackageResponse> call, Throwable t) {
                progressDialog.dismiss();
                new AlertDialog.Builder(LogisticsDeliver.this)
        ...
        if(search.equalsIgnoreCase("") )
        {
            for(int i = 0; i< logisticPackageData.size(); i++ )
            {
                ...
                if(asnacceptance)
                {
                    ...
                    Boolean deliverdetails = logisticPackageData.get(i).getDeliveryDetails() == null;
                    if((deliverdetails && acceptance && pickupdetails))
                    {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.logout) {
            ...
            Intent intent  = new Intent(LogisticsDeliver.this,LoginActivity.class);
